(function () {
  ...
  document.title = `${bundleName} — project-kb Viewer`;
  ...
  // Auto-show the first Project Domain node if available, else the first concept.
  const initial =
    bundle.nodes.find((n) => n.data.type === "Project Domain") ||
    bundle.nodes[0];
